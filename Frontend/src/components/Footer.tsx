      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {["Features", "Pricing", "Analytics", "API"].map((item) => (
                <li key={item}>
                  <a href="#" className="text-sm text-dark-300 hover:text-accent-400 transition-colors duration-200">
                    {item}
                  </a>
                </li>
              ))}
        ...
        <div className="mt-10 pt-6 border-t border-glass-border flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-4">
            {/* GitHub */}
            <a href="#" className="text-dark-400 hover:text-accent-400 transition-colors" aria-label="GitHub">
