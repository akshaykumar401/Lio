      ...
      <div className="relative w-full max-w-md animate-slide-up">
        ...
        <div className="glass-card p-6 sm:p-8" id="login-form-card">
          ...
          <div className="grid grid-cols-2 gap-3">
            <button className="flex items-center justify-center gap-2 py-2.5 rounded-xl border border-glass-border hover:bg-white/5 text-sm text-dark-200 hover:text-white transition-all">
